...
public:
   ...
   void reset() { vector<int> tmp; tmp.swap(_data); } //_data becomes empty.
   ...
   bool empty() const { return _data.empty(); }
    void SetRowdata(size_t s, ifstream& ifs);
    void UpdateRowData(size_t s, ifstream& ifs, int v);
    bool CheckEmptyRow(size_t s, DBRow& r);
...
private:
    ...
    bool CheckEmptyRow(size_t _nCols, DBRow& row)
    {
